...
<html lang="en">
    ...
    <head>
        ...
        <!-- Custom CSS -->
        <link href="assets/vendor/sbadmin/css/sb-admin-2.css" rel="stylesheet">
    ...
    <body>
        ...
        @include('frontend.layouts.header')
            ...
            <div id="container" style="padding:30px; padding-top:15px;">
                @yield('content')
            </div>
        ...
        <script src="assets/vendor/sbadmin/js/sb-admin-2.js"></script>
